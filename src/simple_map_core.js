...
function updateDetailVisibility(){const bounds=visibleContentBounds();Array.from(document.querySelectorAll('.detailDataset')).forEach(el=>el.classList.toggle('hidden',!datasetVisible(el,bounds)))}
